...
define([
  ...
  return declare([Evented], {
    ...
    _init: function () {
      ...
      if (this.config.corsServer > 0) {
          array.forEach(this.config.corsServer, function (url) {
    ...
    _initializeApplication: function () {
      ...
      if (this.config.proxyurl) {
        ...
        array.forEach(this.config.secureServices, function (serviceUrl) {
            console.log("Service Url used: " + serviceUrl);
            urlUtils.addProxyRule({
                urlPrefix: serviceUrl,
