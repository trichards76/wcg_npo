...
define({
    ...
    "toolbarLabels": false,
    "splashModal": false,
    "splashTitle": "DSD NPO Mapping Application",
    "splashContent": "Splash Content goes here for DSD NPO",
    "splashButtonText": "Close",
    "find": null,
    "localize": true,
    "units": null,
    ...
    "corServers": ["https://localhost", "http://localhost", "http://10.0.74.206", "https://webservices.westerncape.gov.za", "http://webservices.westerncape.gov.za"],
    "secureServices": ["https://webservices.westerncape.gov.za/server/rest/services/DSD/"],
    "dsdServices": {
        "dsdnpoSubplaces": "https://webservices.westerncape.gov.za/server/rest/services/DSD/NPO_Census2011_SubplaceBoundaries/MapServer/0"
    },
    "dsdPrintServices": {
        "url": "https://webservices.westerncape.gov.za/server/rest/services/DSD/ExportWebMap/GPServer/Export%20Web%20Map"
    },
    "defaultSymbols": {
        "highlightedPolygonSymbols": { "type": "esriSFS", "style": "esriSFSSolid", "color": [150, 0, 0, 50], "outline": { "type": "esriSLS", "style": "esriSLSSolid", "color": [0, 0, 0], "width": 2 } },
        "newlySelectedPolygonSymbols": { "type": "esriSFS", "style": "esriSFSSolid", "color": [0, 255, 0, 50], "outline": { "type": "esriSLS", "style": "esriSLSSolid", "color": [0, 255, 0], "width": 3 } }
    },
    "helperServices": {
        "geometry": {
            "url": "https://webservices.westerncape.gov.za/server/rest/services/Utilities/Geometry/GeometryServer"
        },
        "printTask": {
            "url": "https://webservices.westerncape.gov.za/server/rest/services/DSD/ExportWebMap/GPServer/Export%20Web%20Map"
        },
